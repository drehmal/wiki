...
|  **Cost**  | **Item** |
|:----------:|:---------------------------:|
| 10 Scales | Mt. Ebonfire Map <br> ![[map_116.png]]{ width="200" } | 
...
|  **Cost**  | **Item** |
|:----------:|:---------------------------:|
| 16 Iron Ingots | Snout Armor Trim <br> ![[snout_armor_trim_smithing_template.png]]{ width="48" } |
| 15 Scales <br> Iron Helmet | *Fortified Helmet* |
| 17 Scales <br> Iron Chestplate | *Fortified Chestplate* |
| 16 Scales <br> Iron Leggings | *Fortified Leggings* |
| 15 Scales <br> Iron Boots | *Fortified Boots* |
| 18 Scales | *Unshakeable* |
| 17 Scales | *Unquakeable* |
| 20 Scales | *Underminer* |
| 32 Scales <br> 16 Blocks of Redstone | *Defiant Arbalest* |
...
Ebonrun was conquered by the [[Empire of Maelihs]] in the [[Dune Wars]] immediately following the [[Fall of Avsohm|empire's collapse]], and has been brutally subjugated by the [[Maelmari]] in the thousand years since. The town is forced to give tribute to Maelihs, its people effectively enslaved on the mountain. The lore text on the artisan items sold here show that its people are steadily mounting a quiet resistance, waiting for the day that they will cast aside their chains and revolt against their oppressors, but that day has not yet come.
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/d0a3rkG_Jk0?" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### Merchant Respawn Commands

In the event that one of the custom merchants in Ebonrun is turned into a witch or dies, the following commands can be used (through a command block) in order to respawn them. See [[FAQ#Can Custom Villagers Be Respawned?|this page]] for more information on these commands.

??? question "Ebonrun Villager Respawn Commands"
...
Ebonrun is one of the towns confirmed to be receiving a rework in [[Drehmal v23|the 2.3 update]], shown in the [end-of-year 2025 blog post](https://www.drehmal.net/post/about-drehmal-2-3-and-beyond).