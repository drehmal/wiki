...
| Av2 1472-1531 | A series of eight stars in the night sky gradually disappears in a straight line, beginning in deep space and approaching Drehmal. A pair of astronomers at a North Heartwood observatory notice this disappearance, along with an insular community of Skyborn Monks on Zedari Island.
| Av2 1531, Ivelar the 15th of Dahrohma[^1] | A mysterious bright blue object appears in the night sky, rapidly moving towards the realm, around Av2 1531. The astronomer who made this discovery burns down his observatory, and a [[Green Serpent]] operative discovers his journal. |
| Av2 1531, Ruhlar the 18th of Dahrohma[^2] | The bright blue object in the sky grows larger. A Raven Unit OSLIN located on the island of [[Sahd]] is dispatched to collect readings on the bright blue object, emerging from under Zedari Island. Meigai Joru, stationed in the nearby town of Galidoh, goes to investigate the disturbance. |
...
| Av2 1702[^2] | [[Muhs]], Aspect of Beasts, is tracked down and slain by the [[Hunting Party]], a group of mortals seeking to end his life for various reasons. The party's lone survivor is executed in Av'Sal. This marks the final straw for many of the Aspects who still spent time on Drehmal, leading them to withdraw entirely from interacting with mortals. |
...
| ???[^3] | Two clans are exiled from Naharja for engaging in acts of gang warfare on the streets, and they go to form the Empire of Rohei. These Ro'Tehrmari come to be heavily persecuted by the Talon, to the point that some hide away in caves rather than risk encountering the La'Tehrmari. |
...
| Likely Av3 878[^4] | With Insohm pushing into the west and suddenly posing a real threat, the Empire of Maelihs prepares a legion of Skullbeasts, but the Burnt Generals are ordered not to deploy the Skullmother again. |
| Likely Av3 885[^5] | Insohm reclaims [[Caer Adacia]] from Mael's armies, and continues advancing into the Tharhan Plains. |
| Likely Av3 887[^6] | Maelihs frees the [[Skullmother]], setting her free into the ocean. |
| c. Av3 895-900 | At the climax of the Battle for Drehmal, [[Yriel]] is sent to intervene, but is slain in a duel against [[Vahid]]. |
| Likely Av3 900[^7] | The Battle for Drehmal comes to an end, with Maelihs and Virtuo reaching a peace treaty. The vast majority of the west, with the exception of [[The Carmine]] and [[Hellcrags]], are restored to Drehmari control under Insohm. |
...
[^2]: As depicted in the [[Archived Memory 2]] teaser for 2.3.
[^3]: One source, [[The Hunting of Greatbeast Muhs]], gives this date, while an advancement for finding the Underwood area gives the date of the Hunting as Av2 1583. 
[^4]: It is incredibly unclear when these events in Tehrmari politics occur, as their stories have functionally no dates listed. However, these developments seem to have come between the Divine Schism and the next crossover between Tehrmari and Drehmari history, the Battle for Drehmal, so they are put here.
[^5]: This date comes from [[Dahroc's Notes]], and is actually written in-map as Av3 678. However, this date does not seem to line up with other sources, and has thus been moved up by 200 years to closely coincide with the end of Av3, as other books suggest is the case.
[^6]: This date comes from [[Dahroc's Notes]], and is actually written in-map as Av3 685. However, this date does not seem to line up with other sources, and has thus been moved up by 200 years to closely coincide with the end of Av3, as other books suggest is the case.
[^7]: This date comes from [[Dahroc's Notes]], and is actually written in-map as Av3 687. However, this date does not seem to line up with other sources, and has thus been moved up by 200 years to closely coincide with the end of Av3, as other books suggest is the case.
[^8]: This date comes from [[Dahroc's Notes]], and is actually written in-map as Av3 700. However, this date does not seem to line up with other sources, and has thus been moved up by 200 years to closely coincide with the end of Av3, as other books suggest is the case.