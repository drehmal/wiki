...
Holotexts are a part of the [[avSYS]] network, and as such, they often cannot be read unless the player's network linkage % is high enough. At the [25%](/Story_and_Features/Story_Locations/25_Percent_Event/) [50%](/Story_and_Features/Story_Locations/50_Percent_Event/), and [75%](/Story_and_Features/Story_Locations/75_Percent_Event/) story locations, players will need to find a node to right-click and attempt reconnection, similar to the ones found at the very [start](/Story_and_Features/Story_Locations/Early-Game_Locations/), of the game. These will not be able to successfully sync the holotext database for that region unless the requisite network linkage has been achieved, and all holotexts in the area will display the following image until synchronized:
