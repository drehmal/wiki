# Archived Memory 2: To Feel The Stars
...
> It’s been too long, my intrepid Seekers! Did you miss me?
>
> I do hope you all enjoyed your time—however brief—with my last offering. The night sky is such a magical thing, and I, for one, can appreciate a skilled storyteller regardless of trade. Great hooks have always been so hard to come by, and I know this one stuck with a good few of you as much as it did myself. Although… it didn’t have much to offer as far as clues go, did it?
> 
> To that end, I think it’s about time to share the next chapter of this story. Of course, I must be transparent again: this is but a short memory, spanning only one night. Don’t expect to get completely lost in there! All the same, I do believe you’ll find this entry a fair bit more… engaging, shall we say? I’m sure you can handle it.
>
> That’ll be all from me, for now. Keep those minds sharp, Seekers! We’ve still so much left to uncover, you and I.
...
[^1]: While an official promotional video asserts that the events of Archived Memory 1 took place "4 days ago", the actual date listed in AM1, the 15th of Dahrohma, is only 3 days off from the 18th of Dahrohma. This discrepancy has yet to be resolved, but the general conclusion is that Archived Memory 2 takes place only a few days after the first.
...
- Four pieces of iron armour, each with a lapis armour trim applied. The helmet and chestplate use the "Sentry" trim, the leggings use the "Tide" trim and the boots use the "Raiser" trim. Each of these items is uniquely named, and has lore text seen below. Additionally, each piece uses the same equipment formatting as all [[Artisan_Items|Artisan Items]] present in version 2.2.
- An iron spear in hotbar slot 1, renamed "Engraved Polearm" and also formatted as an Artisan Item. It has the Sharpness III and Unbreaking II enchantments. Its lore text reads: "A sleek steel glaive of Sahiran make, standard-issue for Meigai soldiers."

![[archived_memory_2_inventory.png]]
...
A building of note is a small temple right next to Joru's house. Inside, the temple features three key murals with messages and offerings underneath. Each is dedicated to a different major spirit worshipped by the Sahdan people during the mid 2nd Avihm.
...
![[am2_temple.png]]
> The interior of the Galidoh temple.

Outside of the temple and the contents within, there is only other place of note within Galidoh. In one of the westernmost homes, an AM2 exclusive [[Artifacts|Artifact]] can be found in a chest, named **Cerulean Creation**. Created by one of the Galidoh smiths, the shield depicts the sudden appearance of the blue object on the horizon. It has no enchantments or other benefits when equipped.

**Lore Text:** *A decorative shield crafted by the smiths of Galidoh, commemorating a momentous change in the sky. The birth of a new star is surely a positive omen.*

![[am2_galidoh.png]]
> The entrance to the quaint coastal town of Galidoh.

When Joru walks to the pier for a better vantage point, the story will next progress. In a field of green particles just off the southeastern corner of the docks, a pitch black orb with a glowing green outline materialises from thin air. A completely black polyhedron, this strange sphere matches neither Drehmal's nor Minecraft's artstyle at all. Moments after appearing, it jettisons away westward across the water with green particles trailing behind it, before turning northwest and disappearing into the hills.
...
Continung further across the bridge, the orb will suddenly fly over Joru's head as they traverse a cliff-side path, moving over the water and towards Zedari Island in the distance. Upon arrival it will ascend up the side of the island before flying directly into the middle of the town. 

![[am2_raven_2.png]]
> The otherwordly dark orb returns.

Located close to another set of docks connecting [[Sahd]] to offshore Zedari Island is another small set of storage sheds and homes. A few other non-responsive drehmari townspeople are also present at this location.

Another exclusive artifact can be found in a nearby house, a yellow candle named **Reverent Heavens**. 
...
![[am2_adrift.png]]
> Five bodies, cast adrift amongst the waves.

Climbing up to the top of of the island where the community is located, the orb is glimpsed for the third time. This time, it hovers directly above the aforementioned location where it burst from the ground, flying down into the crater soon after Joru sees it.
...
A majority of buildings are devoid of noteworthy items, the single exception being the largest building in the village: a temple or prayer site of sorts where a mural of [[Drehmal]] encircling the island of [[Sahd]] with their long body covers the back wall.

In a chest before the mural is a [[Letters_to_the_Sky|series of four letters]] written by one of the elder Skyborn over the course of their lifetime. The last entry is very recent, penned only a short time after the orb's appearance. Importantly, these letters reveal that the disappearance of several stars in the night sky as seen in [[Archived_Memory_1|Archived Memory 1]] were also noticed by the Skyborn monks on this island.
...
![[am2_facility_ent.png]]
> The entrance to the mysterious green and blackstone facility.

Inside the facility, the only way to progress is to drop into a large docking bay. The bay appears abandoned or damaged, with a large part of the structure and stairway eroding and water starting to flood into the central chamber.

Present at the very bottom of this chamber is the black orb, presumably having docked and is otherwise immobile. While Joru is within a reasonable distance to the orb, they can hear a continuous stream of alien beeps and other technological sounds being emitted by the orb. 
...
Following a partially collapsed stairway, Joru will find a peculiar terminal next to where the orb is located. Approaching it makes the terminal reactivate, whereupon it will begin brodcasting a basic facility diagnostic along with relaying three correspondence logs between the orb and an unknown entity. The logs will be projected as custom player heads and to read them Joru must make eye contact with each one in order.

A full transcript of the facility dialogue can be found [[AM2_facility286_logs|here]].

![[am2_facility_terminal.png]]
> The terminal with all three logs projected.

In the first log, a mysterious voice (whose text is coloured green) sends a command to awaken the long dormant orb, which is actually a Raven Unit OSLIN. This entity orders the Raven to make its way to the surface and collect information readings on the blue object in the sky. 

In the second log, the Raven returns from its scouting mission with some basic results, but was somehow blocked from taking more precise measurements. It sends a request to make another expedition at nightfall, which the entity permits.

In the third log, the Raven returns from its second excursion. Readings include how the blue object has an "elevated" luminosity and velocity, as well as an incalculable amount of "potency". The Raven concludes that "contact [is] likely imminent", before awaiting further instructions from the entity.
...
No further progress can be made after this point and the memory is concluded.
...
On the stairway leading to the facility terminal, a single Crying Obsidian[^4] with a lightning rod sticking out of it can be found. Its purpose is unknown.

[^4]: Renamed "Silent Obsidian" by the resource pack.

## Lore and Implications

!!! danger "This section begins to delve further into the content presented in this memory. Due to the nature of the content, it is heavily recommended that you do not continue reading until you have beaten Drehmal [[Drehmal v22|version 2.2]] and reached the designated black concrete Credits room. If you have not done so, there are no major spoilers ahead, but some pages accessible from this section will include significant spoiler warnings."

In general, the Archived Memory is an expansion of the storyline presented in the first Archived Memory, along with bringing a few new points of interest to the community's attention.

Similar to the previous memory, the title of the map's folder gives its day as "Ruhlar". This follows the nomenclature of days of the week in Drehmal, but is not one of the days of the week that previously existed in other versions of the map via the [[(REMOVED) Calendar of Drehmal|removed Calendar of Drehmal book]]. This has also been confirmed to be part of a finalized calendar system rewrite in 2.3.

### Sahdan Culture/History

Given that the date of this memory is placed within approximately one decade of the founding of [[Avsohm]] out of the [[Chosen Kingdom]], the Sahd seen in this memory is one that has likely never interacted with or even heard of the empire.

In this time period the Sahdan people are known as Meigoh, imperial soldiers have the title of Meigai and commanders/high-ranking positions are Meigomo. In a promotional video released by the development team, the island itself is also referred to as Meigoh, suggesting that the name of [[Sahd]] came into use later on. This directly contradicts the use of the name Sahd in [[Av2_1360_-_Prisoners|a book]] written in Av2 1360, which hints at a Sahdan history overhaul or rewrite in the upcoming update.

The highest ranking individual in Sahd at this point in time is likely the figure mentioned in [[Imperial_Orders|Imperial Orders]]: Her Majesty Onota II, the Spiritvessel. The capital of Meigoh might have been the abandoned [[Emperor's_Estate|Emperor's Estate]] or a different place altogether. Also mentioned in Imperial Orders is that it has been 2,131 years since the Meigoh presumably started keeping track of time. Since the official year is only Av2 1531, then this means that Meigoh culture and time-keeping traditions have been around 600 years before the [[Felling]].[^5]
...
The theology of the Meigoh appears to revolve heavily around a concept known as The Great Cycle, with cultivation and growth always followed by loss and sundering before the cycle repeats. The Principal Spirits tie into this cycle, with each of them being associated with some aspect of a prior catastrophe. Zedoh protects the people from the "cyclic nadir of burning skies", Dahe's mural depicts a vast chasm in the earth and Osaigah is connected to some kind of tsunami-like event. It is unknown if the Principal Spirits' role is for them to hold back the coming apocalypse or for them to be placated by the Meigoh so they will not cause the apocalypse themselves.

The monks on Zedari Island are called "Skyborn" due to their devotion to Zedoh, but whether this also entails a physical distinction from regular [[Drehmari]] (such as [[Tehrmari]] ascension) is unknown.

The simplified version of the [[Drehmal_v23###march-2026|August 2026 teaser]], "First comes the sky. The land caught between. The sea takes its dues." could be the order in that these catastrophes would occur. An entity called "The Great Destroyer" is also mentioned multiple times in relation to this former calamity, but it's not clear if it refers to a physical entity or a personification of some concept.

While the "orphic calamity" mentioned in [[The_Principal_Spirits|The Principal Spirits]] could merely be a story of the Meigoh culture, the vivid descriptions of exactly what the calamity was like could be a mythologised version of the events that led up to [[Felling|The Felling]] over 1000 years after it happened.

Interestingly, while there is a mural of [[Drehmal]] on Zedari Island, there is no mention of their name anywhere in the memory (this could be due to a lack of sources in the map). Stangely, Dahe occupies a very similar domain to Drehmal and is also associated with the colour green as shown in the Galidoh temple murals.

The description of the "Engraved Polearm" describes the weapon as being of "Sahiran make". While "Sahiran" sounds like the demonym for the island of Sahd, the proper demonym is "Sahdan", which means that this weapon's origins must come from some other region or settlement.
...
Facility 286, by the time Meigai Joru discovers it, is in a state of heavy decay. When first activated, the Raven unit is unaware of the current date. This could be because the faction has had little need for this facility until the appearance of the blue object in the sky.

The Raven Unit OSLIN[^6] takes the form of a pitch black sphere with a glowing green outline whilst serving the purpose of a surveilance drone. It may have a metallic or otherwise solid hull under the void-like covering because when prodded with a glaive, the blade "glanced off with a metallic clink".

[^6]: It is unknown what "OSLIN" stands for.

The Raven exhibits the ability to fly, teleport, and take readings of stars. As described in [[Tenebrae]], the orb also has a self-defence mechanism that behaves similarly to how spagettification occurs around real-world black holes. Notably, the orb does not deploy this feature unless threatened, such as when prodded at by Inai or when Joru intrudes into the facility. According to the description of the Meigai Bascinet, the Meigoh believed that the soul resided in the head. Because a Verdant Froglight replaces the player's Head slot when they enter Spectator Mode, this "unravelling" effect may include the forced removal of the player's soul from their body

Due to how the Raven is ordered to go take readings on the "anomaly" (blue object), it's likely that this faction did not expect its appearance. Given that the faction is now aware of the ridiculous capacities of this object, it can be assumed that after the events of the memory they would take further actions regarding it.

### The Blue Object

Since its last appearance in [[Archived_Memory_1|Archived Memory 1]], the blue object in the southern sky has only grown larger, implying that it is getting closer and closer to Drehmal. It has likely not breached Drehmal's [[Veil]], as its intense speeds would likely mean that it would make contact with [[Disc|The Disc]] incredibly quickly if it were to do so.

Intermittently throughout the night, the object is targeted by various shapes of yellow energy in the sky. These phenomena are likely offensive in nature, and the yellow colouring of the patterns heavily resembles [[Primal_Energy|Primal Energy]]. Assuming that the attacks are indeed Primal Energy, either [[Khive]] or an [[yellow|extremely mysterious late-game character]] may be responsible. The latter option is more likely due to the domains and abilities of both individuals in relation to the object's current location.
...
In Av4 100, only a single gong structure is present on Zedari Island. Galidoh, in the modern day, is only home to a vague semblance of ruins. Most prominent is the town gateway which still exists in 2.2.

The location that [[New_Sahd|New Sahd]] can be found in the Fourth Avihm is empty in the memory and devoid of any structures.

Once the Raven unit has been activated, the central black orb will continue growing infinitely. This quirk persists even if the player has already died and entered Spectator Mode.

![[am2_raven_bigger.png]]
> I think you can stop now.

[[Lorahn]] does move throughout the course of the memory, but will stop at certain intervals until the player has reached a certain story event. It begins moving at sunset, stopping partway to its apex. After the player sees the orb for the first time, it will continue moving until it reaches midnight. After the second orb sighting, it will continue slightly past midnight before stopping. When the player reaches Zedari Island, it will continue moving until it nears the horizon, before stopping permanently.
