...
| ??? | Over the course of the Avihm, the rest of the Aspects are created both by the Tree and by the other Aspects. The Tree creates the Major Aspects [[Vayniklah]], [[Voynahla]], [[Lai]], and [[Loe]] very early into the realm's history, and the rest of the Minor Aspects are, for the most part, children of the Major Aspects. |
| ??? | The Primal Tree creates the first [[Drehmari]], who go on to populate the world it has created. This world consists of three similarly sized continents, the central continent being [[Lore Locations#Primzahl|Primzahl]], where the Tree stands. |
