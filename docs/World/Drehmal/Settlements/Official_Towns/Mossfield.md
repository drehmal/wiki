...
The Mossfield Library is a relatively small building in southeastern Mossfield, which contains only one book—[[Old Mossfield]], which gives a short overview of the history of Mossfield's storied predecessor.
