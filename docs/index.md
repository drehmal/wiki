...
Drehmal is a Minecraft survival-adventure map that boasts a massive, rich open world, many custom gameplay features, an original storyline, and more! 

The most recent version of Drehmal is v2.2.1: Apotheosis, built for Minecraft Java Edition 1.20.1.
