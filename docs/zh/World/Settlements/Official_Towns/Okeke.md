...
![[okeke.png]]{ align=right width="300" }
...
The lighthouse, at Okeke's northern dock, is home to an artifact in an item frame—the [[Artifacts#Alloyed Gold Rapier|Alloyed Gold Rapier]]—as well as a book on a lectern at the top of the structure, [[The Primal Sapling]].
...
|  **Cost**  | **Item** |
|:----------:|:---------------------------:|
| 10 Scales | Merijool Map <br> ![[map_114.png]]{ width="200" } | 
...
The [[Runic Blacksmith]] in Okeke is located in the southwest, at "The Seasoned Hammer", beneath the signature blue wool tent. This trader sells one armor trim and [[Artisan Items#Okeke|eight artisan items]], including a full set of chainmail armor, which comes enchanted with Unbreaking X.
...
| 20 Scales | *Weighted Flametreads* |
| 20 Scales | *Coldsnap* |
| 28 Scales <br> 1 Diamond | *Charm of Rationality* |
| 30 Scales <br> 6 Pufferfish | *Tetrodotox* |
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/9Xem1lAHvuk?" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
??? question "Okeke Villager Respawn Commands"
